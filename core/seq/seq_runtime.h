...
#ifndef SEQ_RUNTIME_PATTERN_CAPACITY
#define SEQ_RUNTIME_PATTERN_CAPACITY 2U
#endif

#ifndef SEQ_LED_BRIDGE_TRACK_CAPACITY
#define SEQ_LED_BRIDGE_TRACK_CAPACITY SEQ_RUNTIME_PATTERN_CAPACITY
#endif

typedef struct {
    seq_project_t        project;
    seq_model_pattern_t  patterns[SEQ_RUNTIME_PATTERN_CAPACITY];
} seq_runtime_t;
